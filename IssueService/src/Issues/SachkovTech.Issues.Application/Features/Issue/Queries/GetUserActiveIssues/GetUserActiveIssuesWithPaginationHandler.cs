...
public class GetUserActiveIssuesWithPaginationHandler
    : IQueryHandlerWithResult<CursorList<IssueDto>, GetUserActiveIssuesWithPaginationQuery>
{
    private readonly ISqlConnectionFactory _sqlConnection;

    public GetUserActiveIssuesWithPaginationHandler(ISqlConnectionFactory sqlConnection)
    {
        _sqlConnection = sqlConnection;
    }

    public async Task<Result<CursorList<IssueDto>, ErrorList>> Handle(
        GetUserActiveIssuesWithPaginationQuery query,
        CancellationToken cancellationToken)
    {
        ...
        parameters.Add("@Status", IssueStatus.AtWork.ToString());
