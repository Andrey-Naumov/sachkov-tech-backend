...
public class GetUserNewIssuesWithPaginationHandler
    : IQueryHandlerWithResult<CursorList<IssueDto>, GetUserNewIssuesWithPaginationQuery>
{
    private readonly ISqlConnectionFactory _sqlConnection;

    public GetUserNewIssuesWithPaginationHandler(ISqlConnectionFactory sqlConnection)
    {
        _sqlConnection = sqlConnection;
    }

    public async Task<Result<CursorList<IssueDto>, ErrorList>> Handle(
        GetUserNewIssuesWithPaginationQuery query,
        CancellationToken cancellationToken)
    {
        ...
        parameters.Add("@Status", IssueStatus.NotAtWork.ToString());
