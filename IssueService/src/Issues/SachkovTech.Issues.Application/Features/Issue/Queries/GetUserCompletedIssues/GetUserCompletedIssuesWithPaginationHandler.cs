...
public class GetUserCompletedIssuesWithPaginationHandler
    : IQueryHandlerWithResult<CursorList<IssueDto>, GetUserCompletedIssuesWithPaginationQuery>
{
    private readonly ISqlConnectionFactory _sqlConnection;

    public GetUserCompletedIssuesWithPaginationHandler(ISqlConnectionFactory sqlConnection)
    {
        _sqlConnection = sqlConnection;
    }

    public async Task<Result<CursorList<IssueDto>, ErrorList>> Handle(
        GetUserCompletedIssuesWithPaginationQuery query,
        CancellationToken cancellationToken)
    {
        ...
        parameters.Add("@Status", IssueStatus.Completed.ToString());
