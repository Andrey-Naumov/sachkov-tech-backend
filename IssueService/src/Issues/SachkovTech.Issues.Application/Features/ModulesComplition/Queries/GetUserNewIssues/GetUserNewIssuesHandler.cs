...
namespace SachkovTech.Issues.Application.Features.ModulesComplition.Queries.GetUserNewIssues;

public class GetUserNewIssuesHandler
    : IQueryHandlerWithResult<CursorList<IssueDto>, GetUserNewIssuesQuery>
{
    private readonly ISqlConnectionFactory _sqlConnection;

    public GetUserNewIssuesHandler(ISqlConnectionFactory sqlConnection)
    {
        _sqlConnection = sqlConnection;
    }

    public async Task<Result<CursorList<IssueDto>, ErrorList>> Handle(
        GetUserNewIssuesQuery query,
        CancellationToken cancellationToken)
    {
        ...
        parameters.Add("@Status", nameof(IssueStatus.NotAtWork));
        ...
        var sqlBuilder = new StringBuilder(
            ...
            FROM issues.issues AS i
                     ...
                     LEFT JOIN issues.user_issues AS ui
                               ON i.id = ui.issue_id
                     LEFT JOIN issues.user_modules AS um
