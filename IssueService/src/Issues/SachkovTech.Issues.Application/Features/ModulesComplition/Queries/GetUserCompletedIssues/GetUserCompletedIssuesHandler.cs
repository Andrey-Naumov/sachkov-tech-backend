...
public class GetUserCompletedIssuesHandler
    : IQueryHandlerWithResult<CursorList<IssueDto>, GetUserCompletedIssuesQuery>
{
    private readonly ISqlConnectionFactory _sqlConnection;

    public GetUserCompletedIssuesHandler(ISqlConnectionFactory sqlConnection)
    {
        _sqlConnection = sqlConnection;
    }

    public async Task<Result<CursorList<IssueDto>, ErrorList>> Handle(
        GetUserCompletedIssuesQuery query,
        CancellationToken cancellationToken)
    {
        ...
        parameters.Add("@Status", nameof(IssueStatus.Completed));
