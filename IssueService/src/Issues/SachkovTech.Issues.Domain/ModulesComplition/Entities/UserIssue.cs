...
public class UserIssue : Entity<UserIssueId>
{
    ...
    internal UnitResult<Error> SendOnReview(PullRequestUrl pullRequestUrl)
    {
    ...
    internal UnitResult<Error> SendForRevision()
    {
        if (Status != IssueStatus.UnderReview)
    ...
    internal UnitResult<Error> StopWorking()
    {
        if (Status != IssueStatus.AtWork)
    ...
    internal UnitResult<Error> CompleteIssue()
    {
        if (Status != IssueStatus.UnderReview)
